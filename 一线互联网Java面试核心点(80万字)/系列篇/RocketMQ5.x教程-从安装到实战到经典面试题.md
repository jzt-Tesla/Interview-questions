...
### 1.2.消息模型
![image.png](./img/U7oNw09TxmhWUJpv/1682494557603-cdaeec45-92ee-49c4-8df1-6f567111f8b7-326761.png)

### 1.3.部署模型
![image.png](./img/U7oNw09TxmhWUJpv/1682494599538-544c73a6-9681-4e9c-8ed6-4b09c12971b4-942735.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682401176294-e504aa3a-f6e1-469d-b175-7b31bba713ce-521984.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682401393351-e34a836e-cb16-46a3-9ad5-7e72ef6acc13-997136.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682401414849-468ea3f0-2d72-4351-b060-5033553fe84c-935177.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682401352215-7d913952-47fe-485f-b433-3aad4e3aae2b-023480.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682401215293-d73baa9e-d432-4b0a-be25-97cda2fe826d-692830.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682401467533-c1d81d87-bf82-47d0-b64c-553e2bce44ee-962085.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682401532373-9c48810a-d897-4780-a2ce-70fde18c5f0d-204913.png)
...
![image.png](./img/U7oNw09TxmhWUJpv/1682055456856-9f846b00-4c1b-49a3-b1d7-4d2a32c66583-882051.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682401691966-d7b93ecc-6651-4bff-9038-413618dfbfb4-127454.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682401747500-a50b6776-5eab-4123-b2d0-564469fa9269-780866.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682401758763-7e10d111-cccc-458f-acae-9b0e607cc21d-880441.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682401807656-bd9d1221-2029-4326-8096-83b8db620815-824737.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682401869646-f3d7e718-824e-4b41-9707-0ba23683e6c4-080256.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682401918149-0761f3d6-ee5f-4931-86a3-2d4ccf6f28e5-887834.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682401962365-fd9ab684-5298-4453-b386-9431d68e5e5a-546505.png)
...
#### 2.出现以下提示则代表消息发送成功
![image.png](./img/U7oNw09TxmhWUJpv/1682401999161-676df375-6ad1-4ec1-bf62-a206966068d2-576661.png)
...
#### 4.出现以下提示则代表消息接收成功
![image.png](./img/U7oNw09TxmhWUJpv/1682402024027-8dfc7e99-692c-4588-88fa-0c77210fac42-328563.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682402042198-c89f5c65-9872-42af-a598-ddb098cc5060-147711.png)

#### 2.关闭NameServer
```powershell
sh ./mqshutdown namesrv
```
![image.png](./img/U7oNw09TxmhWUJpv/1682402056230-1a622989-eee2-4953-bdf1-86e9dd683752-497113.png)

#### 3.查看服务
![image.png](./img/U7oNw09TxmhWUJpv/1682402072819-598e9feb-6deb-4835-be56-4e148deb04c6-977541.png)
**至此RockMQ单机测试成功，接下来搭建集群。**

## 4.RocketMQ集群架构
刚才的演示中，我们已经体验到了RocketMQ是如何工作的。我们回头看RocketMQ的集群架构，就能够有更全面的理解了。![1682055456856-9f846b00-4c1b-49a3-b1d7-4d2a32c66583.png](./img/U7oNw09TxmhWUJpv/1682055456856-9f846b00-4c1b-49a3-b1d7-4d2a32c66583-669026.png)
...
![image.png](./img/U7oNw09TxmhWUJpv/1682065550569-f0bc546d-f9e2-4a99-82bc-c935837649ce-560284.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682069415085-7eb17954-b3df-4fbf-8b2f-85f001967950-850580.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682402142590-a1286c28-475b-4f7c-877c-198c253f3687-408933.png)

##### 2.服务之间设置免密登陆，三个机器都使用ssh-keygen生成秘钥。提示录入直接回车即可
```powershell
[root@localhost ~]# ssh-keygen
```
![image.png](./img/U7oNw09TxmhWUJpv/1682402219424-6f23afe7-a2dd-41f3-9ba8-30f0a2be4e09-061044.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682402321111-73467679-8e92-4f77-85ad-85102d4cc7e3-786706.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682402416840-7b707361-5535-45eb-a297-d717a424152e-933136.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682403715954-6f7aa472-4287-441a-86ed-fe4b460305c9-020122.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682403855079-6239d3b9-45e4-4fc5-8563-574f0c234390-979796.png)
...
#The broker[broker-b, 192.168.43.136:10911] boot success. serializeType=JSON and name server is worker1:9876;worker2:9876;worker3:9876
```
![image.png](./img/U7oNw09TxmhWUJpv/1682405188142-a2e12c85-39aa-4ec9-8fdf-5a1f58ab75d0-789042.png)
...
[root@localhost bin]# ./tools.sh org.apache.rocketmq.example.quickstart.Producer
```
![image.png](./img/U7oNw09TxmhWUJpv/1682405328890-fad4362a-178b-4441-8cfd-d6585226fb01-815889.png)
```powershell
# worker3接受消息
[root@localhost bin]# ./tools.sh org.apache.rocketmq.example.quickstart.Consumer
```
![image.png](./img/U7oNw09TxmhWUJpv/1682405425065-baf3cb68-229c-48ca-af48-56ad30073952-777711.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682405761027-f951332a-19e9-4b8e-87c7-036682aad2b7-606341.png)
...
$MAVEN_HOME/bin:
```
![image.png](./img/U7oNw09TxmhWUJpv/1682405636539-64bd711f-39a5-43b0-988b-7bd708d16227-616895.png)
...
#显示如下信息即安装成功
```
![image.png](./img/U7oNw09TxmhWUJpv/1682405778553-23ea46d7-9fe0-4a91-8dd8-59735537920b-420714.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682405918403-79f0363c-cde8-40f3-ad8a-4401e14f5b74-685145.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682405927708-3f0c6c35-f052-4f57-996d-50f3fffb3188-940161.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682405994630-c9185d07-7950-4561-abab-1b780284c22e-375547.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682406135232-976ae3d3-a4c2-4218-9e7f-2a6f3ab75596-616617.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682406205434-9586ea01-f1e6-4488-b295-f4d87527229f-747772.png)

##### 4.2.4.8.启动成功后访问：[http://192.168.43.134:8080/#/](http://192.168.43.134:8080/#/)  操作dashboard界面:
![image.png](./img/U7oNw09TxmhWUJpv/1682406282646-a19f4c6b-eb46-485c-8a44-578992a7c274-205503.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682406292904-2d0c7cf1-d436-430a-870a-0d72bc23b350-225302.png)
...
```
![image.png](./img/U7oNw09TxmhWUJpv/1682406751967-b9bf08fe-6ebd-4a1c-99ef-379507783779-606060.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682406791488-3b2eab72-0a17-4120-8b03-91096a06b8cd-068726.png)
...
[root@localhost bin]# ./tools.sh org.apache.rocketmq.example.quickstart.Consumer
```
![image.png](./img/U7oNw09TxmhWUJpv/1682406860017-621c07e1-58d5-4d57-aa71-7df850c6e031-153409.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682406947042-068c6f36-1890-4d2d-81a3-ba5fda9b490e-527190.png)

##### 4.2.5.4.登录dashboard页面查看注册成功
![image.png](./img/U7oNw09TxmhWUJpv/1682406993296-3256d583-1b9a-4732-8fbf-b5b8ebc3524e-560557.png)
...
![image.png](./img/U7oNw09TxmhWUJpv/1682663876526-f469a066-38cb-449f-990b-b4c2a6d554ba-878702.png)
工程创建后，我们添加Pom依赖：
![image.png](./img/U7oNw09TxmhWUJpv/1682663965503-65f0da62-c550-4cf5-bdd9-a1234ef846c5-565973.png)
...
#### 5.7.2.事务消息的实现机制
![image.png](./img/U7oNw09TxmhWUJpv/1682254344862-453d269a-4d6d-4c29-bb34-1c7f82302fde-365443.png)
...
![image.png](./img/U7oNw09TxmhWUJpv/1682409718455-057a0eaa-52dd-4322-9d5f-61a67b36a5be-517160.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682410620811-813c407e-1f7c-4fa3-b79d-f7e72f7d1713-373053.png)
...
三个角色构成的消息存储结构如下：
![image.png](./img/U7oNw09TxmhWUJpv/1682421840048-14c12602-4a44-49d0-ac6c-ec51bc0a70bc-741958.png)
消息存储过程：
![image.png](./img/U7oNw09TxmhWUJpv/1683876636207-c79f4974-ab55-4e91-ad9f-cde81b1cdc07-749024.png)
...
rokectMQ消息模型：![1682494557603-cdaeec45-92ee-49c4-8df1-6f567111f8b7.png](./img/U7oNw09TxmhWUJpv/1682494557603-cdaeec45-92ee-49c4-8df1-6f567111f8b7-409357.png)
...
三个机器都是如此
![image.png](./img/U7oNw09TxmhWUJpv/1682309624800-83b0d376-9d02-401b-9024-7db40af53fd8-173038.png)

### 8.2.bash_profile配置：cat ~/.bash_profile

##### 8.2.1worker1：
![image.png](./img/U7oNw09TxmhWUJpv/1682310017975-0fabb150-203e-4224-8b02-53be79332023-702813.png)

##### 8.2.2.worker2、worker3：
![image.png](./img/U7oNw09TxmhWUJpv/1682310060407-1050a3fb-621f-44e4-a696-95653005ca6a-287147.png)

### 8.3.conf/broker.conf配置文件：cat borker.conf

#### 8.3.1.worker1：borker.conf
![image.png](./img/U7oNw09TxmhWUJpv/1682310261074-ab371d69-b787-4253-85e8-97c78e263ab5-912869.png)

#### 8.3.2.主2从架构：cd conf/2m-2s-async/

##### 8.3.2.1.worker2：broker-a.properties
![image.png](./img/U7oNw09TxmhWUJpv/1682310467610-4660c136-063e-4667-85fb-099edc873458-392018.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682310489037-cfb29ca6-4327-475e-8c71-959cf89a4f59-242700.png)

##### 8.3.2.2worker2：broker-b-s.properties
![image.png](./img/U7oNw09TxmhWUJpv/1682310549000-b78c0d3a-2f81-4342-a75c-a488de446c5c-114720.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682310568431-7a641c39-fe67-44b8-8371-cb42baef21d9-679631.png)

##### 8.3.2.3.worker3：broker-b.properties
![image.png](./img/U7oNw09TxmhWUJpv/1682403477459-e19ae8e8-d1be-460f-9c52-ec1da60b7e9e-554371.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682403488311-5109c6be-942c-4e5a-a04a-9288fc30518e-901720.png)

##### 8.3.2.4.worker3：broker-a-s.properties
![image.png](./img/U7oNw09TxmhWUJpv/1682403511347-0275aacb-2051-4938-910d-2a496c0fcd8b-794920.png)
![image.png](./img/U7oNw09TxmhWUJpv/1682403525043-2f11c9d1-c822-4427-b7db-8f2cd0f634c5-503525.png)

### 8.4.Maven配置（worker1）

#### 8.4.1.本地仓库路径
![image.png](./img/U7oNw09TxmhWUJpv/1682310837447-3009d601-8200-4019-ae43-14de07ca8755-404645.png)

#### 8.4.2.阿里云配置
![image.png](./img/U7oNw09TxmhWUJpv/1682310877791-18aea129-a929-436e-a387-d63f447ef2bd-086977.png)

### 8.5.整体文件目录结构
![image.png](./img/U7oNw09TxmhWUJpv/1682310143055-1f5bf414-23f2-4162-afef-b32dcac62ce3-699130.png)
